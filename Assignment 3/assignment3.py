...
def build_from_substrings(S, T):
    ...
    while current_target_index < len(T):
        ...
        # Changes the processed part of T
...
class PrefixTrie:
    ...
    def insertion(self, string):
        ...
        # If the string and $ is connected to the last character, then the string is in the Trie and the word counter
        # just needs to be incremented. (insert_traversal would return True)
